...
//if ($type == 'create') {
    $new_item_templates = array(array('Name' => 'title', "Operator" => "in",'Value' => 'Item or listing not available'));
...
foreach($item_details['CustomFields'] as $cf) {
           ...
           $result = callAPI("GET", null, $url, false);
            if($result['ID']) {
                ...
                $token = array(
                    ...
                    'SellerName' => $item_details['MerchantDetail']['FirstName'],
                    'SellerDisplayName' => $item_details['MerchantDetail']['DisplayName'],
                    'ImageUrl' => $item_image,
                    'ItemName' => $item_name,
                ...
                //send the EDM
                    ...
                    $data = [
                        'From' => $item_details['MerchantDetail']['Email'],
                        'To' => $follower_email,
                        'Subject' => $subject,
                        'Body' =>  $emailContent
